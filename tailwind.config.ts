  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "cotton-candy": {
          DEFAULT: "hsl(var(--cotton-candy))",
          foreground: "hsl(var(--cotton-candy-foreground))",
        },
        orchid: {
        ...
        streak: {
          empty: "hsl(var(--streak-empty))",
          light: "hsl(var(--streak-light))",
          medium: "hsl(var(--streak-medium))",
          strong: "hsl(var(--streak-strong))",
          intense: "hsl(var(--streak-intense))",
        },
        sidebar: {
